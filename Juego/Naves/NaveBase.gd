...
var estado_vivo:int = ESTADO.VIVO			##	estas lineas no estan 
var estado_muerto:int = ESTADO.MUERTO		## en el codigo que usa el
var estado_cheat:int = ESTADO.INVENCIBLE	## profesor. fijate borrarlas
